...
SECRET_KEY = 'e*qy+k(^@y(glz7i353+w73i%yfwy3sq)ptm=%v1tr!*vft=0k'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'utils.render.AotoPackRender',
        'rest_framework.renderers.BrowsableAPIRenderer',
    ),
    'EXCEPTION_HANDLER': 'utils.render.exception_handler',
